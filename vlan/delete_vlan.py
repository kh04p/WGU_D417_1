...
with ConnectHandler(**user_network) as ssh:
	output = ssh.send_command('delete vlan 100',use_textfsm=True)
	print("**********************************")
	print("********** USER NETWORK **********")
	print("Successfully sent VLAN deletion command.")

with ConnectHandler(**acct_network) as ssh:
	output = ssh.send_command('delete vlan 200',use_textfsm=True)
	print("**********************************")
	print("********** ACCT_NETWORK **********")
	print("Successfully sent VLAN deletion command.")

with ConnectHandler(**mgmt_network) as ssh:
	output = ssh.send_command('delete vlan 300',use_textfsm=True)
	print("**********************************")
	print("********** MGMT_NETWORK **********")
	print("Successfully sent VLAN deletion command.")

with ConnectHandler(**it_network) as ssh:
	output = ssh.send_command('delete vlan 400',use_textfsm=True)
	print("**********************************")
	print("**********  IT_NETWORK  **********")
	print("Successfully sent VLAN deletion command.")
